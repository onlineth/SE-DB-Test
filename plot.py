...
def main_plot(file, lineradius=1):
        ...
        for i, o, p in zip(mctrk_x, mctrk_y, mctrk_z):
            ...
            for j, k, l in zip(mctrk_x, mctrk_y, mctrk_z):
                if i != j and o != k and p != l:
                    ...
                    if dist < lineradius:
                        ax3.plot([i, j], [o, k], [p, l], linewidth=2, picker=4, c='red')

        s3 = ax3.scatter(mctrk_x, mctrk_y, mctrk_z, c=psize, cmap='viridis', s=30)
...
main_plot('double_beta/mctruehits_trk_0.dat').show()
