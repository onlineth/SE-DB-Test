...
To do:
-  treat the Monte Carlo information (point ordering) for double beta decay events
...
for vid in vtrk_ID_temp:
    ...
    vtrk_neighb.append([-1])  # do not know how to create an empty list, insert "someting"
...
if (plot_trks):
    ...
    ##             s3 = ax3.plot(mctrk_x,mctrk_y,mctrk_z,'s',markersize=int(mctrk_E*5000));
